...
function attachmentTemplate(fileType, fileName, imgURL = null) {
    ...
    if (fileType != "image") {
        ...
        if (userRole != 'Fan') {
            $data += '<div class="number  mt-3 d-flex"><span class="minus " > - </span ><input name="price" class="input-price" type="text"id="premium_cost" value="0.00" /><span class="plus ml-1">+</span></div>';
        }
        $data += '</div >';
        return ($data);
    } else {
