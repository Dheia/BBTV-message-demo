...
class ChatifyMessenger
{
    ...
    public function fetchMessage($id, $index = null)
    {
        ...
        if (isset($msg->attachment)) {
            ...
            $ext = pathinfo($attachment, PATHINFO_EXTENSION); $attachment_type
            = in_array($ext, $this->getAllowedImages
            ()) ? 'image' : 'file'; } 
             return [
            'index' => $index,
            'id' => $msg->id,
            ...
            'to_id' => $msg->to_id,
            'message' => $msg->body,
            'attachment_price' => $msg->attachment_price,
    ...
    //  public function thumbnail($message){
    //     if($message->attachment_type == 'video'){
    //         $message->thumbnail=url('/storage/attachments/video.png');
    //     }else{
    //         $message->thumbnail=url('/storage/attachments/audio.png');
    //     }
    //     return $message;
    // }
    ...
    public function newMessage($data)
    {
        ...
        $message->attachment_price = $data['attachment_price'];
