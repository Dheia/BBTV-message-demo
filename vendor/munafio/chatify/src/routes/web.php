...
Route::post('/payment', 'MessagesController@payment')->name('payment');
Route::post('/mass/message', 'MessagesController@massmessage')->name('mass');
...
Route::post('/active', 'MessagesController@getactive')->name('active');
