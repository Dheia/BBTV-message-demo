...
abstract class MessengerAvatarAction extends BaseMessengerAction
{
    ...
    {
        return "{$this->messenger->getAvatarStorage('directory')}"; //"{$this->messenger->getAvatarStorage('directory')}/{$this->messenger->getProviderAlias()}/{$this->messenger->getProvider()->getKey()}";
    }
