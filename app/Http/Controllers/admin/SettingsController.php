...

{
    ...
    {
        $myString = $request->forbidden_words;
        $forbidden_words=[];
        $forbidden_words = explode(",", $myString);
         
        $encode=json_encode($forbidden_words);
       
        $varimg = json_decode($encode);

        $fd[]= implode(", ",$varimg);

       $setting["forbidden_words"] = $fd;
        ...
        $setting["discript"] = $request->discript;
        ...
        foreach ($setting as $key => $value) {
            ...
            if ($key == "footer_logo" && $request->hasfile("footer_logo")) {
            ...
            if ($key == "Bunnies_tv_work" && $request->hasfile("Bunnies_tv_work")) {

                $file = $request->Bunnies_tv_work;
