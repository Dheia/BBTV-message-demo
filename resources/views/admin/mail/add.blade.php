            ...
            <div class="col-md-6">
               <div class="form-group">
                  ...
                  <select class="form-control select2" name="mail_cat">
                     ...
                     <option value="placed" {{isset($mail) && ($mail->msg_category == 'placed') ? 'selected' : ''
                     }}>Order Placed</option>
                     <option value="cancelled" {{isset($mail) && ($mail->msg_category == 'cancelled') ?
                     'selected' : '' }}>Order Cancelled</option>
                     <option value="delivered" {{isset($mail) && ($mail->msg_category == 'delivered') ?
                     'selected' : '' }}>Order Delivered</option>
                     <option value="return" {{isset($mail) && ($mail->msg_category == 'return') ? 'selected' : ''
                     }}>Order Return Order</option>
                     <option value="refunded" {{isset($mail) && ($mail->msg_category == 'refunded') ? 'selected'
                     : '' }}>Order Refunded</option>
                     <option value="contact us" {{isset($mail) && ($mail->msg_category == 'contact us') ?
                     'selected' : '' }}>Contact Us</option>
                     <option value="password reset" {{isset($mail) && ($mail->msg_category == 'password reset') ?
                     'selected' : '' }}>Password reset</option>
                     <option value="signup" {{isset($mail) && ($mail->msg_category == 'signup') ? 'selected' : ''
                     }}>Signup</option>
                     <option value="giftcard" {{isset($mail) && ($mail->msg_category == 'giftcard') ? 'selected'
                     : '' }}>Gift Card Code</option>
                     <option value="use gift card" {{isset($mail) && ($mail->msg_category == 'use gift card') ?
                     'selected' : '' }}>Use Gift Card </option>
                     <option value="vendor approve" {{isset($mail) && ($mail->msg_category == 'vendor approve') ?
                     'selected' : '' }}>Vendor Approve</option>
                     <option value="order complete" {{isset($mail) && ($mail->msg_category == 'order complete') ?
                     'selected' : '' }}>Order Complete</option>
                     <option value="vendor-signup" {{isset($mail) && ($mail->msg_category == 'vendor-signup') ?
                     'selected' : '' }}>Vendor Signup</option>
                     <option value="contact-us-user" {{isset($mail) && ($mail->msg_category == 'contact-us-user')
                     ? 'selected' : '' }}>Contact User </option>
                  </select>
               </div>
            </div>
            <div class="col-md-6">
               <div class="form-group">
                  ...
                  <input type="email" class="form-control" name="from_mail" placeholder="From Email"
                     value="{{isset($mail) ? $mail->from_email : ''}}">
               </div>
            </div>
            <div class="col-md-6">
               <div class="form-group">
