      ...
      <div class="row">
        ...
        <div class="col-md-2">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="footer_logo" value="footer logo">



            <input type="file" class="form-control" id="exampleInputuname_1" name="footer_logo"
        ...
        <div class="col-md-4">
          ...
          <div class="form-group">
            ...
            <img src="{{ url('images/logo').'/'.$setting['footer_logo'] ?? "" }}" style="height:100px;width:200px;"
              alt="logo">
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputuname_1" name="name"
              value="{{($setting['name'])??''}}">
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="name_0" value="commission">
            ...
            <input type="text" class="form-control" id="exampleInputuname_1" name="commission"
        ...
        <div class="col-md-12">
          ...
          <div class="form-group">
            <label class="control-label ">Business Discription</label>
            <textarea type="text" class="form-control" id="exampleInputuname_1" name="discript"
              value="{{($setting['discript'])??''}}">{{($setting['discript'])??''}}</textarea>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputuname_1" name="country"
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputuname_1" name="state"
              value="{{($setting['state'])??''}}">
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputuname_1" name="city"
              value="{{($setting['city'])??''}}">
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputuname_1" name="postcode"
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputuname_1" name="help_number"
              value="{{($setting['help_number'])??''}}">
          </div>
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputuname_1" name="pan_number"
              value="{{($setting['pan_number'])??''}}">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputuname_1" name="cin_number"
              value="{{($setting['cin_number'])??''}}">
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputuname_1" name="gst_number"
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputuname_1" name="url"
              value="{{($setting['url'])??''}}">
        ...
        <div class="col-md-6">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInputuname_1" name="address"
        ...
        <div class="col-sm-6">
          ...
          <input type="text" class="form-control" id="exampleInputuname_1" name="hour"
            value="{{($setting['hour'])??''}}">
        </div>
        <div class="col-md-12">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <div class="left-inner-addon input-container">
                  ...
                  <input type="text" class="form-control" placeholder="twitter" name="pinterest"
            ...
            <h4 class="mt-5 ml-2">Forbidden Words</h4>
            <hr>
            <div class="col-md-12">
              ...
              <div class="form-group">
                ...
                @php
                $forbidden_words = json_decode($setting['forbidden_words']);
                @endphp


                <textarea type="text" class="form-control" name="forbidden_words" id="tag-input1">@foreach($forbidden_words as $item) {{$item}}
                  @endforeach
                </textarea>
            ...
            <h4 class="mt-5 ml-2">How Bad Bunnies Tv Works</h4>
            <hr>
            <div class="col-md-12">

              <div class="form-group">
                <input type="file" name="Bunnies_tv_work" id="" class="form-control">



                @if(!empty($setting['Bunnies_tv_work'] ))
          <div class="form-group mt-3">


                      <video width="180" height="150" controls autoplay loop class="mt-3">  
                        <source src="{{ url('images/logo').'/'.$setting['Bunnies_tv_work'] ?? "" }}" type="video/mp4">  
