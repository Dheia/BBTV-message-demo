<script src="{{ asset('vendor-message/messenger/app.js?id=b64871fbdd6c8dd8cacd8060bf11e25b') }}"></script>
...
@stack('Messenger-load')
        ...
        common : {
            ...
            base_css : '{{ asset('vendor-message/messenger/app.css?id=3b55d7c19427a2dad7488300afe9035c') }}',
            dark_css : '{{ asset('vendor-message/messenger/dark.css?id=c6a1828963e845e69f67939f8fbd0d39') }}',
...
$(this).closest('.checklist').on('click',function(){
alert('fgsf');

$('.model_message').val(id);
})
});
