              ...
              <form action="{{route('mass')}}" method="post" enctype="multipart/form-data"> @csrf 
                <div class="row">
                  <div class="col-12">
                    ...
                    <select name="user" class="form-control" name="" id="">
                      <option value="0">--Select-- 
                      </option>
                      <option value="1">All 
                      </option>
                      <option value="2">Favoutite
                      </option>
                    </select>
                  </div>
                  <div class="col-12">
                              ...
                              <div class="img-thumbs img-thumbs-hidden" id="img-preview">
                                <div class="price">
                                  <div class="number  mt-3 d-flex">
                                    ...
                                    <input name="price" class="input-price" type="text" id="premium_cost" value="0.00" />
                                    <span class="plus ml-1">+
                                    </span>
                                  </div>
                                </div>
                              </div>
                ...
                @php
                $data=App\Models\ChMessage::where('mass_status','1')->orderBy('created_at', 'desc')->first();
                @endphp
                @if (!empty($data))
                @php
                $dt = new DateTime();
