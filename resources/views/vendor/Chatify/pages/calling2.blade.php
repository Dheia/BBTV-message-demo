...
<div class="wrapper j-wrapper">
    <main class="app" id="app">
        <div class="page"> 
            <!-- JOIN -->
              <form class="join j-join" method="post">
                ...
                <div class="hellocallme">helo devl</div>
                    <div class="join__row">
            ...
            <!-- <h1 >
                <a class="text-danger" id="hellocallme">ttttttttttttttt</a>
            </h1>
            <a class="callmeman"  >Hello call mes</button> -->
...
<!-- <script src="{{ url('quickblox.min.js') }}"></script> -->
