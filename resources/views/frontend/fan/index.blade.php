...
<div class="col-sm-12 col-md-8 col-lg-9 mt-5 col-xl-9 ">
                        ...
                        <div class="mgs-content ">
                           <div class=" text-white">
                              ...
                              <div class="d-flex justify-content-between mt-3">
                                 <div class="row  ">
                                    <div class=" col-xl-3 col-md-3 col-sm-3 col-3 user-image ">
                                       <img src="@if(!empty($latestMessage->sender->profile_image)) {{ url('profile-image') . '/' . ($latestMessage->sender->profile_image) }} @else {{ url('profile-image/user.png') }} @endif" class="mgs-image img-fluid">
                                    </div>
                                    <div class=" col-7 real-mgs pl-3 pr-2">
                                       <!-- <small>TheTeenageWitch</small> -->
                                       <small>@if(!empty($latestMessage->body)) {{ Str::limit($latestMessage->body, 40) }}  @else Send a attachment @endif
                                       </small>
                                    </div>
                                    <div class=" col-2 text-center" style="padding:0px">
                                       <small class="mr-2 text-center time_text">{{date('g:i a', strtotime($latestMessage->created_at))}}</small>
                                    </div>
                                 </div>
                              </div>
                           </div>
   ...
   <div class="Online-now-models mt-3">
      ...
      <div class="row">
         <div class="col-md-12">
            <div class="owl-carousel owl-theme" id="online-slider">
         ...
         <div class="">
            ...
            <div class="">
               <div class="row">
                  ...
                  <div class="col-lg-4 col-md-4 p-0 mt-5 ">
