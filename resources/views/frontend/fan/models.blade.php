...
.fan_model_wrap{
  ...
  <div class="onlinewrapp-bg">
    <div class="container">
    <div class="onlinepage-hading-wrapp" id="m-view-header">
      <div class="uper_wrapper mt-5">
      <div class="up_wrap d-flex">
      <div class="spec">
          <h1>Models <b></b><span>(24) </span></h1>
...
<select name="models" class="fan_mod_filter text-center">
  ...
  <option value="audiocall">Audio Call
  </option>
  <option value="onlinenow">Online Chat
  </option>
</select>
  </form></div>
  <div style="width:50%;"> <select name="sort" class="recentoption text-center">
            <option value="online">Recently Active
            </option>
            <option value="joining">Join Date
            </option>
            <option value="rank">Rank
            </option>
            <option value="low-to-high">Price: Low to
              High
            </option>
            <option value="high-to-low">Price: High to
              Low
            </option>
          </select></div>
      ...
      <div class="onlinepage-hading-wrapp" id="web_view">
        <div class="spec">
          <h1>Models <b></b><span>({{count($online)}}) </span></h1>
        </div>
      ...
      <div>
        <div class="OnlineNow-wrappers">
          <div class="Online-now-wrapp row">
            @foreach($online as $item)

            <div class="onlinenow-model-wrapper  col-sm-6 col-md-4 col-lg-4 col-xl-4 ">
            @if($item->is_online == 1)
              ...
              <a href="{{url('/',[$item->slug])}}">
                <div class="first-col-wrapper">
                  ...
                  @else @endif
                  <div class="colname-wrapper fan_model_wrap">
