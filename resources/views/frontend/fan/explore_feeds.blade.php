      ...
      <div class="expolor-post-wraper ">
         <div class="postprofile-wrapper">
            ...
            <div class="post-icon-wrapepr added feedSection" feedId="{{$value->feed_id}}">
               ...
               <a class="addwish ">
                  <i data-id="{{ $value->id ?? '' }}" class="fa add-to-wishlist addLike mr-3 @if ($Auth_feed > 0)fa-heart feed_liked @else fa-heart-o @endif" feed_id="{{ $value->feed_id }}"></i>
         ...
         <div class="tips-add-icon-wrapper sdfsdfsdf">
            @if ($model_contact <= 0)
