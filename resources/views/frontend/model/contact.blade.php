...
<div class="col-sm-12 col-md-9 col-lg-9 mt-5 mb-5">
                            <div class="heading ">
                                    <h4 class="text-white"><b>Contact Model Support</b></h4></div>
                                  <div class="card">
...
@endif
    ...
    maxlength = "10">
                    ...
                    @enderror
                                    ...
                                    <div class="row">
                                      <div class="col-6">   <div class="supp mt-4">
                                        <small><b>Support Hours</b></small><br>
                                        <small>Mon - Fri: 10 AM - 6 PM (PST)<br>
                                        Weekends: Limited</small>
                                      </div></div>
                                      <div class="col-6">   <div class="supp mt-4">
                                        <small><b>Phone Support</b></small><br>
                                        <small>Phone support is available by appointment only. Please 
                                                  email models@badbunnies.com with your name, 
                                                  phone number, problem/issue and availability within, 
                                                  Mon - Fri 10am - 6pm Pacific Time.</small>
                                      </div></div>
                                    </div>
