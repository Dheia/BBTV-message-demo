...
<div class="onlinewrapp-bg">
    ...
    <div>
      <div class="OnlineNow-wrappers">
        <div class="Online-now-wrapp">
          ...
          <div class="onlinenow-model-wrapper">
            ...
            <a href="{{$item->slug}}">
              <div class="first-col-wrapper">
                ...
                @endphp  
                  <img class="model-img" src="{{ url('profile-image') . '/' . $image }}" alt="Model-Image">
                <div class="col-img-overlay"></div>
                <div class="col-overlay"></div>
                @php
                $data=\Carbon\Carbon::parse($item->created_at)->format('M d, Y');
                @endphp
                @if($data > $getdate) <label class="new-label">New</label>
                  @else
                  @endif
          ...
          @endforeach
          @if($onlinecount<1) <div class="empty_state">
  ...
  <form id="serch" method="get" action="{{ route('online-now') }}">
      ...
      <div class="filterside-wrapepr">
        ...
        <div class="gender-filter-wrapper filt_wrap">
          ...
          <div class="ckeckfilter">
            <input type="checkbox" id="checkbox-2-13" name="gender[]" value="transgender"
              class="filter-checkbox filterbig-checkbox filter transgender" {{ in_array("transgender", $gender)
              ? 'checked' : '' }} />
        ...
        <div class="gender-filter-wrapper filt_wrap">
          ...
          <label class="ckeckfilter">
            <input type="radio" {{ (request()->input('orientation') == $value->id) ? 'checked': '' }} name="orientation"
            {{request()->input('orientation')}} id="s-option1.{{$key}}." class="filter orientation"
            value="{{$value->id}}" />
        ...
        <div class="gender-filter-wrapper filt_wrap">
          ...
          <div class="language-filter-wrapp">
            <div class="gender-filter-wrapper">
              ...
              @if ($key < 6) <label>
                <div class="ckeckfilter">
                  <input type="checkbox" id="checkbox-2.{{$key}}." {{ in_array($value->id, $ethnicity) ? 'checked' :
                  ''}} name="ethnicity[]" class="filter-checkbox filterbig-checkbox filter ethnicity"
                  value="{{$value->id}}" />
        ...
        <div class="gender-filter-wrapper filt_wrap">
          ...
          <div class="language-filter-wrapp">
            <div class="gender-filter-wrapper">
              ...
              @if ($key < 5) <label>
                <div class="ckeckfilter">
                  <input type="checkbox" id="checkbox-3.{{$key}}." {{ in_array($value->id, $language) ? 'checked' : ''}}
                  name="language[]"
        ...
        <div class="gender-filter-wrapper filt_wrap">
          ...
          <div class="language-filter-wrapp">
            <div class="gender-filter-wrapper">
              ...
              @if ($key < 4) <label>
                <div class="ckeckfilter">
                  <input type="checkbox" id="checkbox-4.{{$key}}." {{ in_array($value->id, $fetish) ? 'checked' : ''}}
                  name="fetish[]"
        ...
        <div class="gender-filter-wrapper filt_wrap">
          ...
          <div class="language-filter-wrapp">
            <div class="gender-filter-wrapper">
              ...
              @if ($key < 4) <label>
                <div class="ckeckfilter">
                  <input type="checkbox" id="checkbox-5.{{$key}}." {{ in_array($value->id, $hair) ? 'checked' : ''}}
                  name="hair[]"
