          ...
          <div class="navbar-wrapper">
              ...
              <div class="nav-btnwrapper home_header_join_btn">
                  <a href="{{ route('user-signup') }}">
                      <button class="joinfree-btn" id="nav-button-join"> Join for free </button></a>
                  @if (isset(Auth::user()->id))
                      <a href="{{ url('/') }}"
                          onclick="event.preventDefault();
                document.getElementById('logout-form').submit();">
                          <button class="login-btn" id="nav-button-logout">Logout</button>
                  ...
                  @else
                      <a href="{{ route('user-login') }}">
                          <button class="login-btn" id="nav-button-login">Login</button>
                      </a>
