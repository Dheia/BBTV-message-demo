...
a.relative.inline-flex.items-center.px-4.py-2.-ml-px.text-sm.font-medium.text-gray-700.bg-white.border.border-gray-300.leading-5.hover\:text-gray-500.focus\:z-10.focus\:outline-none.focus\:ring.ring-gray-300.focus\:border-blue-300.active\:bg-gray-100.active\:text-gray-700.transition.ease-in-out.duration-150 {
    ...
    <div class="onlinewrapp-bg">
      <div class="container">
        ...
        <h1>Video <b>Call</b> <span>( {{$videocount}} Available ) </span></h1>
          ...
          <div class="OnlineNow-wrappers">
            ...
            @endphp
                ...
                <div class="col-overlay">
                  <div class="colname-wrapper video_wrapp">
                  @if($item->is_online == 1)
                  ...
                  @endif
                    <span class="colcost">${{$item->cost_videocall}} per minute</span>
                  </div>
                </div>
              </div>
            </a>
        ...
        <div id="pagination">
        {{ $videosex->withQueryString()->links('paginate.paginate') }}
        </div>
        <form id="serch" method="get" action="{{ route('video-calls') }}">
