...
<body>
    @php $validation='0'; if(!empty($errors->all())){ $validation='1'; } @endphp
    <div class="login-bg">
                            ...
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link @if($validation) active @endif" id="pills-profile-tab" data-bs-toggle="pill"
                                        ...
                                        aria-controls="pills-profile" @if($validation=='1') aria-selected="true" @else aria-selected="false" @endif >
                                        Sign Up
                                    </button>
                                </li>
                            </ul>
                                ...
                                <div class="tab-pane fade @if(!$validation) show active @endif loginform-wrapper " id="pills-home" role="tabpanel"
                                    ...
                                    @endif -->
                                        ...
                                        <div class="login-pagebtn-wrapp">
                                            <button class="singupbtn" id="lg_btn">Login</button>
                                        </div>
                                        <p class="byloginline">
                                ...
                                <div class="tab-pane fade  @if($validation)  active show @endif" id="pills-profile" role="tabpanel"
                                    ...
                                    <!-- <div class="tab-pane fade loginform-wrapper" id="pills-home"
                                        ...
                                        <form method="POST" action="{{ route('storeuser') }}">
                                            ...
                                            <small class="text-danger" style="margin: 0px 27px;">
                                                @error('readbox')
                                                {{ $message }}
                                                @enderror
                                            </small>
