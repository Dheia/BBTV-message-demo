                                  ...
                                  <div class="card">
                                    <div class="card-body text-white">
                                      <div class="row set_con justify-content-between mt-3">
                                        ...
                                        <div class="col-sm-12 col-md-6 mt-2">
                                          <button class="btn feel-btn  text-white">DISMISS NOTIFICATIONS</button>
                                        </div>
                                      </div>
                                      <div class="row set_con justify-content-between mt-3">
	...
	<div class="modal-dialog modal-confirm">
		<div class="modal-content">
			...
			<div class="modal-footer justify-content-center">
				...
				<a href="{{url('fan/deluser',Auth::user()->id)}}" class="del_btn " >Delete</a>
			</div>
		</div>
	</div>
	</div>
	...
	<div class="modal-dialog modal-confirm">
      ...
      <form action="{{url('fan/sendSMS')}}" method="get" enctype="multipart/form-data">
        ...
        <label for="">Number</label>
			...
			<div class="modal-footer justify-content-center">
				<button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
        <button type="submit" class="sub_btn btn btn-info">Submit</button>
			</div>
      </form>
		</div>
	</div>
