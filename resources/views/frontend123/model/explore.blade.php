                              ...
                              <div class="explorepost-inner-wrapper">
                                 <div class="row">
                                    ...
                                    <div class="column  col-lg-6 col-md-6 col-sm-12 ">
                                       ...
                                       @if ($number % 2 != 0)
                                       @include('frontend.model.explore_feeds')
                                       @endif
                                       @endforeach
                                    </div>
                                    <div class="column col-lg-6 col-md-6 col-sm-12">
                 ...
                 @endif </span></a>
                                                   <div class="added">
                                                      ...
                                                      <ul class="mydropdown-menu">
                                                         <!-- @if ($pupular->price <= 0)
                                                         <li> <a href="{{ url('fan/add-collection', [$pupular->id]) }}"
                                                            class="editPostClass">Add To
                                                            Collection</a>
                                                         </li>
                                                         @endif -->
                                    ...
                                    style=" cursor: pointer; " onclick="copy('{{ url('/', [$pupular->user->slug ?? ''] ) }}?feed_id={{$pupular->id}}')">Copy Link To Post</a>
                                                         ...
                                                         <li><a class="editPostClass report_post"
                                                            data="{{ $pupular->id }}"
                                                            data-toggle="modal"
                                            ...
                                            <span class="sr-only">Next</span>
                                                ...
                                                <div class="input-group d-flex">
                                                   ...
                                                   <button type="button" data-toggle="modal"
                                                      ...
                                                      class="model-contect-btn send-msg"><i
