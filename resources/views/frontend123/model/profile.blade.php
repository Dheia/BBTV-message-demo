...
/*img.expolor-img {
    ...
    width: 383px !important;
            ...
            <div class="col-sm-12 col-xs-12 col-md-6 col-xl-6">
                <div class="model-details-wrapper">
                    ...
                    <div>
                       ...
                       @if($slugdata->user->is_away=='1')<button class="notify_me-btn btn btn-danger">Notify Me</button> @endif
                    </div>
        ...
        @if(count($model_feeds)>=1) <div class="detail_page-wrapper">
            ...
            <div class="tab-content" id="pills-tabContent">
             ...
             {{$hu??''}}
                     ...
                     @if(!empty($json_data['twitter']))
                         <div class="modellink-wrrap mr-5">
