                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xl-4">
                                <div class="card">
                                    <div class="card-body text-center statistics-info">
                                        ...
                                        <h6 class="mb-2 number-font">${{$today_total_earning}} Total |
                                            ${{$today_total_admin}} Admin</h6>
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xl-4">
                                <div class="card">
                                    <div class="card-body text-center statistics-info">
                                        ...
                                        <h6 class="mb-2 number-font">${{$month_total_earning}} Total |
                                            ${{$month_total_admin}} Admin</h6>
                                        <p class="text-muted"></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xl-4">
                                <div class="card">
                                    <div class="card-body text-center statistics-info">
                                        ...
                                        <h6 class="mb-2 number-font">${{$year_total_earning}} Total |
                                            ${{$year_total_admin}} Admin</h6>
                                        <p class="text-muted"></p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="sorting d-flex pr-2">
                                  ...
                                  <div class="sorting d-flex pr-2">
                                   <select name="model_sorting" id="model-fliter" class="form-control" required>
                                        ...
                                        <option value="{{$value->id}}" @if(app('request')->input('model_sorting')==$value->id) selected @endif >{{$value->model_name}}</option>
                                        @endforeach
                                    </select>
                    ...
                    <table id="example" class="table table-striped table-bordered text-nowrap w-100">
                        ...
                        <tbody class="filter_data">
                            ...
                            <tr>
                                ...
                                <td><b>{{ $log->user->first_name ?? '' }} {{ $log->user->last_name ?? '' }} {{ $log->method ?? '' }} To {{ $log->model->first_name ?? '' }}
                                    </b></td>
                                <td>${{ $log->price }}</td>
                                ...
                                <td class="">
                                    <div class="btn btn-sm btn-primary ml-3" data-toggle="modal" data-target="#logview"><i
                                            class="fa fa-eye"></i></div>
                                    <!-- <form action="{{ route('dashboard.user-logsdelete', $log->id) }}" method="POST"
