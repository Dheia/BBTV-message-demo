...
return [
    ...
    */
    'files' => [
       ...
       'default_not_found_image' => public_path('messenger-chat/messenger/images/image404.png'),
        'default_ghost_avatar' => public_path('messenger-chat/messenger/images/users.png'),
        'default_thread_avatar' => public_path('messenger-chat/messenger/images/threads.png'),
        'default_bot_avatar' => public_path('messenger-chat/messenger/images/bots.png'),
    ],
    ...
    */
    'message_edits' => [
        'enabled' => env('MESSENGER_MESSAGE_EDITS_ENABLED', false),
